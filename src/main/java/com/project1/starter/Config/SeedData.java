...
public class SeedData implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        account01.setDate_of_birth(LocalDate.parse("2003-11-05"));
        ...
        account02.setDate_of_birth(LocalDate.parse("2003-11-05"));
        ...
        account03.setDate_of_birth(LocalDate.parse("2003-11-05"));
        ...
        account04.setDate_of_birth(LocalDate.parse("2003-11-05"));
